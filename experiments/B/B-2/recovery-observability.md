...
レビュー補足：退会outbox/DB内台帳断片にも退会＋28日の元期限を付ける。restoreで古い断片が戻った場合も期限を延長せず消去してから公開する。期限前に全復元元消去を確認できなかった場合、台帳延命か無検査公開のどちらかを選んで適合扱いにせず、公開停止・要件未達として人間判断へ上げる。長期の地域停止中に削除期限を守れるとの保証はない。
